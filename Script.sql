...
CREATE TABLE IF NOT EXISTS TB_ATENDIMENTO_PRODUTO (
    ...
    CONSTRAINT FK_ATEND_PROD_ATENDIMENTO FOREIGN KEY (FK_ATENDIMENTO) REFERENCES PUBLIC.TB_ATENDIMENTO (ID),
    CONSTRAINT FK_ATEND_PROD_PRODUTO FOREIGN KEY (FK_PRODUTO) REFERENCES PUBLIC.TB_PRODUTO (ID)
);
...
CREATE TABLE IF NOT EXISTS TB_ATENDIMENTO_SERVICO (
    ...
    CONSTRAINT FK_ATEND_SERV_ATENDIMENTO FOREIGN KEY (FK_ATENDIMENTO) REFERENCES PUBLIC.TB_ATENDIMENTO (ID),
    CONSTRAINT FK_ATEND_SERV_SERVICO FOREIGN KEY (FK_SERVICO) REFERENCES PUBLIC.TB_SERVICO (ID)
);
...
CREATE TABLE IF NOT EXISTS TB_PAGAMENTO (
    ...
    FK_ATENDIMENTO      BIGINT NOT NULL,
    ...
    CONSTRAINT FK_PAGAMENTO_ATENDIMENTO FOREIGN KEY (FK_ATENDIMENTO) REFERENCES PUBLIC.TB_ATENDIMENTO (ID),
...
INSERT 
 ...
 VALUES
('Maria Silva', 'maria.silva@email.com', '(31) 99999-1111', 2, 2000.00),
('João Pereira', 'joao.pereira@email.com', '(31) 98888-2222', 3, 4500.00),
('Ana Costa', 'ana.costa@email.com', '(31) 97777-3333', 4, 1800.00),
('Carlos Souza', 'carlos.souza@email.com', '(31) 96666-4444', 5, 2200.00),
('Fernanda Lima', 'fernanda.lima@email.com', '(31) 95555-5555', 6, 6000.00),
('Lucas Almeida', 'lucas.almeida@email.com', '(31) 94444-6666', 2, 2100.00),
('Beatriz Martins', 'beatriz.martins@email.com', '(31) 93333-7777', 3, 4700.00),
('Rafael Gomes', 'rafael.gomes@email.com', '(31) 92222-8888', 4, 1900.00),
('Juliana Rocha', 'juliana.rocha@email.com', '(31) 91111-9999', 5, 2300.00),
('Tiago Fernandes', 'tiago.fernandes@email.com', '(31) 90000-0000', 3, 5200.00);
